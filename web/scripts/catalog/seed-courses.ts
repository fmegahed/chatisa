/**
 * SEED ONLY (v6.7.0): the hand-written ISA catalog the app used until
 * v6.6.x. The catalog collector reads it only when catalog/courses.json does
 * not exist, to rebuild the catalog from nothing; the app reads
 * catalog/courses.json through lib/scout/courses.ts.
 *
 * The ISA course catalog Job Scout matched against. Snapshot of
